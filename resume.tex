...
\cvitem{Languages}{Java, C/C++, Python, Haskell, Scala, Prolog, Coq, Ocaml, Scheme, Rust, Swift}
...
\begin{itemize}
	\item Machine learning and its applications in Natural Language Processing (NLP)
