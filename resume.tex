...
%\item{
\cventry{Nov. 2018 -- Present}{A Compiler}{\textsf{Ark Compiler}}{engineer at Huawei Research}{}{
	\begin{itemize}
		\item Researched and implemented one invoke-kind instruction for compiler (details confidential)
		\item Implemented one lexer and parser for compiler (details confidential)
	\end{itemize}
}
%}
%\item{
\cventry{Aug. 2017 -- Nov. 2018}{Wire Transfer system for block trading agent}{\textsf{WIRE}}{engineer at Citigroup}{}{
	...
	\begin{itemize}
		...
		\item Developed reconciliation module for downstream data warehouse team: abstracted business logic to TCP-like 3-way handshake protocol through Finite State Machine model
		\item Implemented component of unmarshalling SOAP message to JavaBean
...
\cvitem{Language}{Haskell, C/C++, Java, Python, Scala, Prolog, Coq, Isabelle}
